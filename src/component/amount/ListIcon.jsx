    ...
    <div>
      <div className={style.container}>
        ...
        <p className={style.subtitle}>
          Streamline your accounts payable process with improved oversight, faster approvals, and
          fewer errors.
        </p>

        <div className={style.content}>
          <div className={style.styledContainer}>
            <h2 className={`${style.title} ${style.listTitle}`}>How We Work for You</h2>
        ...
        <div className={`${style.content} ${style.contentReverse}`}>
          <div className={style.styledContainer}>
            <h2 className={`${style.title} ${style.listTitle}`}>What You Get in Return</h2>
            <ul className={style.points}>
              {points.map((point, idx) => (
                <li key={idx} className={style.border}>
                  <img src={tickIcon} alt="tick" className={style.tick} />
