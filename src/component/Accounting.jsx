...
const cardData = [
  {
    ...
    title: 'Bookkeeping',
    discription:
      'Our experts are here to assist you not just during tax season, but all year round. Let us handle the details, so you can focus on what you do best.',
  },
  {
    image: image2,
    title: 'Payroll',
    discription:
      'We furnish outsourced, part-time bookkeeping with a full-time presence at a fraction of the cost of hiring an internal CFO.',
  },
  {
    image: image3,
    title: 'Business Formation',
    discription:
      'Determining the fair economic value of a business or company unit for its sale value, establishing a partnership, taxation, etc.',
  },
];
    ...
    <div className={style.AccountingContainer}>
      <div className={style.Accounting}>
        ...
        <p className={style.AccountingParagraph}>
          Our experts are here to assist you not just during tax season, but all year round. Let us
          handle the details, so you can focus on what you do best.
        </p>
      </div>
