...
const Position = () => {
  return (
    <div className={style.positionContainer}>
      <h2 className={style.positionTitle}>
        Limited Positions
        <br />
      ...
      <div className={style.positionGrid}>
        {positionData.map((item, index) => (
          <PositionCard key={index} image={item.image} title={item.title} />
        ))}
      </div>
      <div className={style.positionButtonWrapper}>
        <button className={style.positionButton}>
          Apply for <span className={style.sub}> Palms Springs, CA </span>
        </button>
        <button className={style.positionButton}>
          Apply for <span className={style.sub}>Whittier, CA </span>
        </button>
        <button className={style.positionButton}>
          Apply <span className={style.sub}> Remotely</span>
        </button>
      </div>
    </div>
  );
