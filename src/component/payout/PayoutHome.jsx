    ...
    <div className={styles.payoutContainer}>
      ...
      <div className={styles.leftSection}>
        <div className={styles.contentWrapper}>
          <button className={styles.payrollButton}>Payroll</button>
          ...
          <p className={styles.payoutDescription}>
            Whether you're a solo entrepreneur or managing a team, our payroll services make paydays
            easy, keep you compliant, and simplify year-end tax filings
          </p>
        </div>
      </div>
