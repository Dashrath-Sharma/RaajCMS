...
const BussinessCardData = [
  {
    ...
    title: 'CEO',
    description:
      'I am very happy with the service. Kevin is personable and professional. He got everything done so quickly and thoroughly within days. I highly recommend this firm.',
    seeYou: 'See you',
    arrow: arrowIcon,
  },
  {
    ...
    title: 'LLC',
    description:
      'Working with Kevin has been great! He helped me file my back taxes and get me back on track! Helped me with my EIN number for my new LLC, which was a headache for me.',
    seeYou: 'See you',
    arrow: arrowIcon,
  },
  {
    ...
    title: 'Founder',
    description:
      'Kevin Bautier at Bean Counter is a knowledgeable professional. He has suggested solutions to miscellaneous concerns and has been excellent to work with over the years.',
    seeYou: 'See you',
    arrow: arrowIcon,
  },
];
  ...
  return (
    <div className={style.WhyBussinessContainer}>
      <div className={style.WhyBussinessContent}>
        <h2 className={style.WhyBussinessTitle}>See Why Business Owners Count on Bean Counter</h2>
      </div>
